...
MOCK_PROJECT_JSON = {
    ...
    "stats": [
        '{"type": "IN_PROGRESS_COUNT", "info": {"not_submitted": 0, "rejected": 0}}',
        '{"type": "SUBMITTED_COUNT", "info": {"pending_review": 0, "approved": 0}}',
        '{"type": "SKIPPED_COUNT", "info": {"pending_review": 0, "approved": 0}}',
    ],
}

MOCK_PROJECT_RESPONSE_JSON = {"data": {"project": MOCK_PROJECT_JSON}}

MOCK_PROJECTS_RESPONSE_JSON = {
    "data": {"projects": {"edges": [MOCK_PROJECT_JSON], "count": 1}}
}
